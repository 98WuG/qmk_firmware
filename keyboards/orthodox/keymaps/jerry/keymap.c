...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    CTL_T(KC_TAB),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,            KC_LBRC, KC_LCBR,          KC_RCBR, KC_RBRC,          KC_H,    KC_J,    KC_K,    KC_L,    LT(_VIM,KC_SCLN), CTL_T(KC_ENT), \
    KC_LSPO,        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   RAISE,   KC_LGUI, KC_LALT,          KC_RALT, KC_SPC, LOWER,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC \
  ),
  ...
  [_LOWER] = LAYOUT( \
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                      											 KC_F6,   KC_F7,       KC_F8,      KC_F9,   KC_F10,  KC_PIPE, \
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,          KC_LCTL, _______,          _______, KC_RCTL,          KC_CIRC, KC_AMPR,     KC_ASTR,    KC_LPRN, KC_RPRN, KC_BSPC, \
    _______, KC_UNDS, KC_PLUS, KC_TILD, KC_PIPE, KC_F11,  _______, KC_DEL,  _______,           _______, _______, _______, KC_F12,  KC_HOME,    KC_COMM,    KC_DOT,  KC_END,  _______ \
  ),

  [_RAISE] = LAYOUT( \
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                      			  	                             KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,              _______, _______,         _______, _______, 	     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC, \
    _______, KC_MINUS,KC_EQUAL,KC_GRAVE,KC_BSLS, KC_F11,  _______, _______, _______,          _______, KC_BSPC, _______, KC_F12,  KC_PGUP, KC_COMM, KC_DOT,  KC_PGDN, _______ \
  ),
