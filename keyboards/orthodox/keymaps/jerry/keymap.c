...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    CTL_T(KC_TAB),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,            KC_LCBR, KC_LBRC,          KC_RBRC, KC_RCBR,          KC_H,    KC_J,    KC_K,    KC_L,    LT(_VIM,KC_SCLN), CTL_T(KC_ENT), \
    KC_LSPO,        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   RAISE,   KC_LGUI, KC_SPC,           KC_LALT, KC_SPC, LOWER,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC \
  ),
