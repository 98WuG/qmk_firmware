...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [BASE_QWERTY_LAYER] = {
    {KC_ESC,                 KC_Q,           KC_W,    KC_E,    KC_R,  KC_T,   KC_Y,    KC_U,  KC_I,    KC_O,    KC_P,                   LT(KEYBOARD_LAYER,KC_QUOT)},
    {CTL_T(KC_TAB),          KC_A,           KC_S,    KC_D,    KC_F,  KC_G,   KC_H,    KC_J,  KC_K,    KC_L,    LT(NAV_LAYER, KC_SCLN), CTL_T(KC_ENT)},
    {KC_LSPO,                KC_Z,           KC_X,    KC_C,    KC_V,  KC_B,   KC_N,    KC_M,  KC_COMM, KC_DOT,  KC_SLSH,                KC_RSPC},
    {LT(GUI_LAYER,KC_LBRC), KC_LCBR, KC_LALT, KC_LGUI, LOWER, KC_SPC, KC_BSPC, RAISE, KC_RGUI, KC_RALT, KC_RCBR,         LT(GUI_LAYER, KC_RBRC)}
  },
  ...
  [BASE_COLEMAK_LAYER] = {
    ...
    {KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_LEFT, KC_DOWN, KC_RGHT, KC_SCLN, KC_ENT },
  ...
  [GUI_LAYER] = {
    ...
    {_______, KC_MPRV, KC_MPLY, KC_MNXT, KC_SLCK, FUCKOFF, ___x___, KC_PAUS, KC_MUTE, KC_VOLD, KC_VOLU, _______}
  },
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
	...
	case FUCKOFF:
      if (record->event.pressed) {
        SEND_STRING(SS_DOWN(X_LGUI)SS_DOWN(X_LSHIFT)SS_TAP(X_ENTER)SS_UP(X_LSHIFT)SS_UP(X_LGUI));
		_delay_ms(500);
		SEND_STRING("fuck off young");
		_delay_ms(500);
