...
[_VIM] =  LAYOUT_ortho_4x12( \
  _______, _______,   KC_BTN2, KC_MS_U, KC_BTN1, QWERTY, _______, _______, _______, _______, _______, _______, \
  _______, _______, KC_MS_L,  KC_MS_D,  KC_MS_R, KC_WH_U, KC_LEFT,  KC_DOWN, KC_UP,  KC_RGHT, _______, _______, \
  _______, _______, KC_ACL0, KC_ACL1, KC_ACL2, KC_WH_D, _______, _______, _______, _______, _______, _______, \
